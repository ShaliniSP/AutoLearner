...
class Repair(object):
    ...
    def repair(self, P, Q, inter, ins=None, args=None, entryfnc=None,
        ...
        M = Matching(verbose=self.verbose, fnmapping = self.fnmapping)
        self.sm = M.match_struct(P, Q, entryfnc = entryfnc)
        if self.sm is None:
        ...
        trace2 = self.gettrace(Q, inter, ins, args, entryfnc)
    ...
    def distance(self, t1, t2, m):
        ...
        # pdb.set_trace()
        x = tree_distance(t1, t2, label_dist=label_dist(m))
        return x
